...
const { saveSubscriptionData } = require("../services/subscriptionService");
...
router.post("/user/subscription", fetchUserSubscriptionData);
router.post("/user/subscription/save", saveUserSubscriptionData);
